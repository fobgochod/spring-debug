...
public class AopLogger {
    ...
    @Pointcut("execution(public Integer com.fobgochod.annotation.aop.service.cglib.CglibCalculator.*(Integer,Integer)) " +
            "|| execution(public Integer com.fobgochod.annotation.aop.service.jdk.JdkCalculator.*(Integer,Integer))")
