...
public class LogUtil {
    ...
    @Pointcut("execution(public Integer com.fobgochod.common.aop.annotation.MyCalculator.*(Integer,Integer)) " +
            "|| execution(public Integer com.fobgochod.common.aop.annotation.SecondCalculator.*(Integer,Integer))")
