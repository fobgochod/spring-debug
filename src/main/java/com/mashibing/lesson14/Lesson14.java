package com.mashibing.lesson14;

import com.mashibing.lesson14.lookup.Apple;
import com.mashibing.lesson14.lookup.FruitPlate;
import com.mashibing.lesson14.replace.OriginalDog;
...
public class Lesson14 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("apple1 = " + fruitplate1.getFruit());
        System.out.println("apple2 = " + fruitplate1.getFruit());

        FruitPlate fruitplate2 = (FruitPlate) ac.getBean("fruitplate2");
        System.out.println("lookup:banana1 = " + fruitplate2.getFruit());
        System.out.println("lookup:banana2 = " + fruitplate2.getFruit());
